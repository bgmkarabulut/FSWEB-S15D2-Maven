...
public class StringSet {
    ...
    public static List<String> findUniqueWords() {
        ...
        String cleanedText = String.valueOf(text.equals("[.,!?\"\\\\]"));


        // Kelimeleri parçala ve küçük harfe dönüştür
        String[] words = cleanedText.toLowerCase().split("\\s+");

        // Unique kelimeleri bir Set içerisinde sakla
        Set<String> uniqueWords = new HashSet<>(Arrays.asList(words));

        // Set'i alfabetik sıraya göre listeye çevir ve döndür
        return uniqueWords.stream().sorted().collect(Collectors.toList());
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Alfabetik sıraya göre unique kelimeler: " + uniqueWords);
    }
}
